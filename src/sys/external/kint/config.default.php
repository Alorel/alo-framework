<?php
   ...
   isset($GLOBALS['_kint_settings']) or $GLOBALS['_kint_settings'] = [];
    ...
    *      APPPATH => 'APPPATH', // make sure the constants are already defined at the time of including this config
    *      file SYSPATH => 'SYSPATH', MODPATH => 'MODPATH', DOCROOT => 'DOCROOT',
    * );
