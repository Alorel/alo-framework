<?php
   ...
   class Kint_Parsers_Color extends kintParser {
      ...
      protected function _parse(& $variable) {
         ...
         $this->value = "<div style=\"background:$variable;\" class=\"kint-color-preview\">{$variable}</div>" .
      ...
      private static function _fits($variable) {
         ...
         return isset(self::$_css3Named[$var]) || preg_match(
            '/^(?:#[0-9A-Fa-f]{3}|#[0-9A-Fa-f]{6}|(?:rgb|hsl)a?\s*\((?:\s*[0-9.%]+\s*,?){3,4}\))$/', $var
         );
      }
