      ...
      function __toString() {
         ...
         foreach($this->results as $r) {
            ...
            $ret .=
               ...
               .
               '<td>' .
               $r[self::P_DEFINITION][self::P_NAME] .
               '</td>'
               .
               '<td><ol style="margin:0;"><li>' .
               implode('</li><li>', $r[self::P_DEFINITION][self::P_ARGS]) .
               '</li></ol></td>'
               .
               '<td><pre>' .
               F::scalarOutput($r[self::P_DEFINITION][self::P_OUTCOME]) .
               '</pre></td>'
               .
               '<td><pre>' .
               F::scalarOutput($r[self::P_OUTCOME]) .
               '</pre></td>'
               .
               '<td style="color:';
